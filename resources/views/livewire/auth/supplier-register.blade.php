<div>
    <main id="main">
        <section class="page-hero">
            <div class="wrap">
                <p class="label">Sign up · Supplier</p>
                <h1>Register your business</h1>
                <p>Gunsmiths, dealers, ammunition, optics, safes, chassis, instructors — free to list. Create your account first; we email a confirmation link, then you add the services you offer. <b>Every new listing is reviewed by staff</b> before it goes live.</p>
            </div>
        </section>
        <section class="block">
            <div class="wrap" style="max-width:520px">
                <form wire:submit="register" class="enquiry-form" novalidate>
                    ...
                    <label class="field">
                        ...
                        <input type="text" wire:model="business_name" required autocomplete="organization" maxlength="160" placeholder="e.g. Delmas Gun Shop">
                    ...
                    <label class="field">
                        ...
                        <small style="color:var(--slate);font-size:12px;display:block;margin-top:4px">
                            We send a confirmation link here. You can't add services until you've clicked it.
                        </small>
